...
<!-- Mirrored from thememascot.net/demo/personal/j/imfundo/v2.0/demo/index-boxed-mp-layout1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Aug 2018 11:05:18 GMT -->
<head>
...
<body class="boxed-layout pt-40 pb-40 pt-sm-0 has-side-panel side-panel-right fullwidth-page" data-bg-img="images/pattern/p34.png">
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
      ...
      <div class="container-fluid p-0">
        ...
        <div id="rev_slider_home_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery34" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
          ...
          <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
            <ul>
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg1.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Slide One">
                <!-- MAIN IMAGE -->
                <img src="images/bg/bg1.jpg" alt="" data-bgposition="center 20%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
              ...
              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg2.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Slide Two">
                <!-- MAIN IMAGE -->
                <img src="images/bg/bg2.jpg" alt="" data-bgposition="center 20%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                  id="slide-2-layer-1" 
              ...
              <!-- SLIDE 3 -->
              <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg3.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Slide Three">
                <!-- MAIN IMAGE -->
          ...
          <div class="col-xs-12 col-sm-6 col-md-4 mb-sm-30">
            <div class="feature-box text-center bg-silver-light p-30 pb-20">
              ...
              <div class="feature-title">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta quia quos a beatae ratione possimus, accusantium!</p>
              </div>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-4 mb-sm-30">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="p-30 mt-0 bg-silver-light">
                ...
                <form id="reservation_form" name="reservation_form" class="reservation-form mt-20" method="post" action="http://thememascot.net/demo/personal/j/imfundo/v2.0/demo/includes/reservation.php" novalidate="novalidate">
                  <div class="row">
                    <div class="col-sm-12">
    ...
    <section id="courses" class="bg-silver-light">
      <div class="container">
        <div class="section-title mb-40">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-uppercase mb-5">Popular <span class="text-theme-colored2">Courses</span></h2>
    ...
    <section id="about">
      <div class="container pt-50 pb-40">
        <div class="section-title">
          <div class="row">
          	<div class="col-lg-4">
              <h3 class="font-28 mt-0"><span class="text-theme-colored2">About </span>Us</h3>
              <div class="line-bottom-theme-colored2"></div>
	            <img src="images/about/2.jpg" class="img-fullwidth" alt="">
	            ...
	            <a href="#" class="btn btn-colored btn-sm btn-theme-colored2">read more</a>
	          </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
              <h3 class="font-28 mt-md-30 mt-0"><span class="text-theme-colored2">Why Choose </span>Us? </h3>
              <div class="line-bottom-theme-colored2"></div>
    ...
    <!-- Divider: Funfact -->
    <section class="layer-overlay overlay-dark-7 parallax" data-bg-img="images/bg/bg1.jpg">
        ...
        <div class="section-title mb-40">
          <div class="row">
            <div class="col-md-12">
              ...
              <h5 class="font-16 text-gray-darkgray mt-5">Meet Our Skilled Teachers</h5>
            </div>
          </div>
        </div>
        <div class="section-content">
    ...
    <!-- Divider: Divider -->
    <section class="parallax divider layer-overlay overlay-dark-7" data-bg-img="images/bg/bg3.jpg" data-parallax-ratio="0.4">
      <div class="container pt-80 pb-90">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 text-center">
            ...
            <h3 class="text-white font-38 font-weight-700 mt-10 mb-0">Let's have a <span class="text-theme-colored2">Video</span> Tour and See Our Recent  <span class="text-theme-colored2">Activities</span></h3>
            ...
            <form id="mailchimp-subscription-form2" class="newsletter-form max-width-535 mt-10">
              ...
              <div class="input-group">
                ...
                <span class="input-group-btn">
                  <button type="submit" class="btn btn-colored btn-theme-colored2 btn-lg m-0" data-height="45px">Subscribe</button>
                </span>
              </div>
            </form>
    ...
    <section class="bg-silver-light">
      <div class="container pt-70 pb-30">
        <div class="section-title">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase title mb-0">Our <span class="text-theme-colored2">Student's </span>Say</h2> 
              <h5 class="font-16 text-gray-darkgray mt-5 mb-0">Student and Parents Opinion</h5>
    ...
    <section id="blog">
      <div class="container pb-sm-40">
        <div class="section-title mb-40">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-uppercase mb-5">Our <span class="text-theme-colored2">Blog</span></h2>
              <h5 class="font-16 text-gray-darkgray mt-5">See Our Recent Blog</h5>
            </div>
          </div>
        </div>
        <div class="section-content">
