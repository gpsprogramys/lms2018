 <meta name="description" content="">
   ...
   <script src="${pageContext.request.contextPath}/js/jquery.validate-1.11.1.min.js"></script>
   ...
   <link rel="stylesheet" href="${pageContext.request.contextPath}/css/main.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/sl-slide.css">
       <link rel="stylesheet" href="${pageContext.request.contextPath}/css/jquery-ui-1.11.4.css">   
    <script src="${pageContext.request.contextPath}/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    
   	<script>
			contextPath= "${pageContext.request.contextPath}";
	</script>
	 <script src="${pageContext.request.contextPath}/js/utility/dateFormat.js"></script>
