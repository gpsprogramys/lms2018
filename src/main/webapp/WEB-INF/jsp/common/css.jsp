...
<link  href="${pageContext.request.contextPath}/js/revolution-slider/css/layers.css" rel="stylesheet" type="text/css"/>
<link  href="${pageContext.request.contextPath}/js/revolution-slider/css/navigation.css" rel="stylesheet" type="text/css"/>
