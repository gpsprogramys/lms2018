...
public class OrganisationTimeForm {
	private int sno;
	...
	public String toString() {
		return "OrganisationTimeForm [sno=" + sno + ", intime=" + intime + ", latein=" + latein + ", outtime=" + outtime
				+ ", earlyout=" + earlyout + ", doe=" + doe + ", dom=" + dom + ", enteredby=" + enteredby + ", active="
				+ active + "]";
	}
