...
public class FacultyLeaveBalanceEntity1 {
	private Long empid;
	private String name;
	...
	public FacultyLeaveBalanceEntity1() {}

	public FacultyLeaveBalanceEntity1(FaculityLeaveMasterEntity1 flme, FacultyEntity1 fe) {
		super();
		this.empid = fe.getId();
	...
	public String toString() {
		return "FacultyLeaveBalanceEntity1 [empid=" + empid + ", name=" + name + ", department=" + department
