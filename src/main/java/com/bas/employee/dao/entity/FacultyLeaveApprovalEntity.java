...
public class FacultyLeaveApprovalEntity {
	...
	public String toString() {
		return "FacultyLeaveApprovalEntity [requestID=" + requestID + ", empName=" + empName + ", empid=" + empid
				+ ", doj=" + doj + ", deptt=" + deptt + ", designation=" + designation + ", leaveFrom=" + leaveFrom
				+ ", leaveTo=" + leaveTo + ", lwp=" + lwp + ", elDays=" + elDays + ", leaveDays=" + leaveDays
				+ ", totalDays=" + totalDays + ", leaveType=" + leaveType + ", purpose=" + purpose
				...
				+ ", cCTo=" + cCTo + ", effectiveDates=" + effectiveDates + ", doapplication=" + doapplication
				+ ", inAccount=" + inAccount + ", el=" + el + ", cl=" + cl + ", cel=" + cel + ", ccl=" + ccl + "]";
	}
