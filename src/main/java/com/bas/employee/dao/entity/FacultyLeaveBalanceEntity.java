...
public class FacultyLeaveBalanceEntity {
	private Long id;
	private String name;
	...
	public FacultyLeaveBalanceEntity() {}

	public FacultyLeaveBalanceEntity(FaculityLeaveMasterEntity flme, FacultyEntity fe) {
		super();
		this.id = fe.getId();
	...
	public String toString() {
		return "FacultyLeaveBalanceEntity [id=" + id + ", name=" + name + ", department=" + department + ", designation=" + designation
